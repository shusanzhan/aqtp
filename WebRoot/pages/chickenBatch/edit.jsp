		...
		<table border="1" align="center" cellpadding="0" cellspacing="0" style="width: 92%;">
			<tr height="42">
				...
				<td ><input type="text" name="user.userId" id="userId"
					value="${user.userId }" class="input-xmedium field" title="用户名"	checkType="string,5,20" tip="用户名不能为空,并且5-20个字符"><span style="color: red;">*</span></td>
			...
			<tr height="42">
				...
				<td ><input type="text" name="user.realName" id="realName"
					value="${user.realName }" class="input-xmedium field" title="用户名"	checkType="string" tip="真实名称不能为空"><span style="color: red;">*</span></td>
			...
			<tr height="32">
				...
				<td><input type="text" name="user.email" id="email"
					value="${user.email }" class="input-xmedium field"  checkType="email" tip="请输入正确的email"><span style="color: red;">*</span></td>
