...
<table width="92%" cellspacing="0" cellpadding="0" border="0"  style="margin-top: 20px;margin: 0 auto;" align="center">
	<tr style="border-bottom: 1px solid black;" height="40">
		<td width="80" align="right">名称：</td><td width="120">无心打红警</td>
		<td width="80" align="right">批次：</td><td width="120">20102批次</td>
		<td  width="80" align="right">品级：</td><td width="120">特级</td>
		<td  width="80" align="right">品系：</td><td width="120">品系</td>
		<td  width="80" align="center"><a href="${ctx }/pages/chickenBatch/list.jsp" style="color: blue;">返回</a></td>
	</tr>
	<tr style="border-bottom: 1px solid black;" height="40">
		<td width="80" align="right">出生日期：</td><td></td>
		<td width="80" align="right">入栏日期：</td><td></td>
		<td width="80" align="right">出栏日期：</td><td></td>
		<td width="80" align="right">数量：</td><td>
		<span style="font-size: 14px;color: red;">500</span>
		</td>
		<td></td>
	</tr>
</table>
			...
			<div class="module listColor" id="module_26">
			  <div class="head">
			    <h4 class="moduleHeader" id="module_26_head">
			      <a class="expand" href="javascript:_resize(26);"></a>      <span onclick="_resize(26);" class="text" id="module_26_text">饲料信息</span>
			  ...
			  <div style="" class="module_body" id="module_26_body">
			    <div style="height:120px;" class="module_div" id="module_26_ul"><ul><ul></ul></ul></div>
			  </div>
			</div>
			<div class="module listColor" id="module_40">
			  <div class="head">
			    <h4 class="moduleHeader" id="module_40_head">
			      <a class="expand" href="javascript:_resize(40);"></a>      <span onclick="_resize(40);" class="text" id="module_40_text">检疫证明</span>
			...
			<div class="module listColor" id="module_6">
			  <div class="head">
			    <h4 class="moduleHeader" id="module_6_head">
			      <a class="expand" href="javascript:_resize(6);"></a>      <span onclick="_resize(6);" class="text" id="module_6_text">饲养员</span>
			  ...
			  <div style="display: block;" class="module_body" id="module_6_body">
			    ...
			    <div style="height:120px;" class="module_div" id="module_6_ul"><ul><li>暂无内部邮件</li><ul>
			</ul></ul></div>
			  </div>
			</div>
			<div class="module listColor" id="module_23">
			  <div class="head">
			    <h4 class="moduleHeader" id="module_23_head">
			      <a class="expand" href="javascript:_resize(23);"></a>      <span onclick="_resize(23);" class="text" id="module_23_text">二维码</span>
			  ...
			  <div style="" class="module_body" id="module_23_body">
			    <div style="height:120px;overflow-y:auto;" class="module_div" id="module_23_ul">
			</div>
			  </div>
			</div>
			<div class="module listColor" id="module_23">
