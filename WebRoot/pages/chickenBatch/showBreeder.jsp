	...
	<form action="" name="frmId" id="frmId" style="margin-bottom: 40px;" target="_self">
		<table border="1" align="center" cellpadding="0" cellspacing="0" style="width: 92%;">
			<tr height="42">
				...
				<td ><input  readonly="readonly" type="text" name="user.userId" id="userId"
					value="${user.userId }" class="input-xmedium field" title="用户ID" url="${ctx }/user/validateUser"	checkType="string,5,20" tip="用户名不能为空,并且5-20个字符"></td>
			...
			<tr height="42">
				...
				<td ><input type="text" name="user.realName" id="realName"  readonly="readonly"
					value="${user.realName }" class="input-xmedium field" title="姓名"	checkType="string,1,10" tip="真实名称不能为空"></td>
			</tr>
			
			<tr height="42">
				<td class="formTableTdLeft" style="width: 60px;">生日:&nbsp;</td>
				<td ><input type="text" name="breeder.birthday" id="birthday"
					value="${breeder.birthday }"  readonly="readonly" class="input-xmedium field" onFocus="WdatePicker({isShowClear:false,readOnly:true})"></td>
			</tr>
			<tr height="32">
			...
			<tr height="32">
				...
				<td><input type="text" name="user.mobilePhone" id="mobilePhone"
					value="${user.mobilePhone }"  readonly="readonly" class="input-xmedium field"  checkType="phoneNo" canEmpty="Y" tip="请输入正确的手机号"></td>
				<td class="formTableTdLeft" style="width: 60px;">座机:&nbsp;</td>
				<td><input type="text" name="user.phone" id="phone"
					value="${user.phone }"  readonly="readonly" class="input-xmedium field"  checkType="phoneNo"  canEmpty="Y" tip="请输入正确的座机号"></td>
			</tr>
			<tr height="42">
			    <td class="formTableTdLeft" style="width: 60px;">邮箱:&nbsp;</td>
				<td ><input type="text"  readonly="readonly" name="user.email" id="email"
					value="${user.email }" class="input-xmedium field" title="邮箱"	checkType="email" canEmpty="Y" tip="请输入正确的邮箱"></td>
			...
			<tr height="42">
				...
				<td colspan="3"><input  readonly="readonly" type="text" name="breeder.graduationSchool" id="graduationSchool"
