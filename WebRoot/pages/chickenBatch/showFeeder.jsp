	...
	<form action="" name="frmId" id="frmId" style="margin-bottom: 40px;" target="_self">
		<table border="1" align="center" cellpadding="0" cellspacing="0" style="width: 92%;">
			<tr height="42">
				...
				<td ><input type="text" readonly="readonly" name="feeder.name" id="name"
					value="${feeder.name }" class="input-large field" title="名称"	checkType="string,1,10" tip="饲料名称不能为空"></td>
			</tr>
			
			<tr height="42">
				<td class="formTableTdLeft" style="width: 60px;">百分比:&nbsp;</td>
				<td ><input type="text" name="feeder.elementsPercentage" id="elementsPercentage" readonly="readonly"
					value="${feeder.elementsPercentage }"  checkType="string,1,100" tip="百分比不能为空" class="input-large field" ></td>
			</tr>
			<tr height="32">
			...
			<tr height="32">
				...
				<td >
					 <textarea rows="" readonly="readonly" cols="" id="note" class="textarea-xxlarge" name="feeder.note">${feeder.note }</textarea>
				</td>
			</tr>
		</table>
