	...
	upload3 = new SWFUpload(
			{
				...
				custom_settings : {
					progressTarget : "uploadFileContent3",
	...
	<form action="" name="frmId" id="frmId" method="post" style="margin-bottom: 40px;" target="_self">
		...
		<table border="1" align="center" cellpadding="0" cellspacing="0" style="width: 92%;">
			<tr height="42">
				...
				<td >
					<input id="newTypeName" type="text" readonly="readonly" name="newTypeName" value="${news.newstype.name }"  checkType="string,1,50" tip="类型不能为空" class="input-large field" onclick="showMenu();" />
			...
			<td class="formTableTdLeft">标题:&nbsp;</td>
				<td ><input type="text" name="news.title" id="title"
					...
					<input type="checkbox" id="isTitlePicture" value="true" name="news.isTitlePicture" onclick="setTitlePicture();"><label for="isTitlePicture">启用标题图片</label>
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					<input type="checkbox" id="isBannerPicture" value="true" name="news.isBannerPicture" onclick="bannerPictureTr();"><label for="isBannerPicture">启用幻灯片图片</label>
				</td>
			</tr>
			...
			<tr height="42">
				...
				<td >
					...
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					<input type="checkbox" id="isLatestNew" value="true" name="news.isLatestNew"><label for="isLatestNew">是否为最新动态</label> 
				</td>
			</tr>
					...
					<table  border="0" cellpadding="0" cellspacing="0" style="width: 100%;" height="80">
						<tr>
							<td height="20" width="100%">
								<div id="div1">
									<div style="padding-left: 5px;">
									<span id="spanButtonPlaceholder3"></span> <br />
								</div>
								<div id="uploadFileContent3" class="uploadFileContent"></div>
								</div>
							</td>
						</tr>
						<tr>
