		...
		<table border="1" align="center" cellpadding="0" cellspacing="0" style="width: 92%;">
			<tr height="42">
				...
				<td ><input type="text" name="user.userId" id="userId"
					value="${user.userId }" url="${ctx }/user/validateUser" class="input-large field" title="用户ID"	checkType="string,5,20" tip="用户名不能为空,并且5-20个字符"><span style="color: red;">*</span></td>
			...
			<tr height="42">
				<td class="formTableTdLeft" style="width: 60px;">密码:&nbsp;</td>
				<td ><input type="password" name="user.password" id="password"
					value="${user.password }" class="input-large field" title="用户名"	checkType="string,6,20" tip="密码不能为空,密码长度为6,20"><span style="color: red;">*</span></td>
			</tr>
			<tr height="42">
			...
			<tr height="32">
				...
				<td >
					<input type="radio" id="sex1"  checked="checked" name="breeder.sex" value="男"><label id="" for="sex1">男</label>
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					<input type="radio" id="sex2"  name="breeder.sex" value="女"><label id="" for="sex2">女</label>
				</td>
			</tr>
			<tr height="32">
