...
;(function($) {
    ...
    $.Autocompleter = function(input, options) {
        ...
        function lastWord(value) {
            ...
            return words[words.length - 1].toString();
        }
        ...
        function parse(data) {
            ...
            //由于返回的是XML,所以data.text的格式是c c# c++,所以需要按照空格分隔
            //var rows = data.text.split(" ");
            for (var i = 0; i < data.length; i++) {
                ...
                if (row) {
                    parsed[parsed.length] = {
                        data: row,
                        value: data.value,
                        result: options.formatResult && options.formatResult(row, data.value) || data.value
                    };
                }
            }
            return parsed;
